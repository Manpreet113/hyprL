...
if [ -f ~/.config/hyprL/settings/wallpaper_cache ]; then
    use_cache=1
...
force_generate=0
generatedversions="$HOME/.config/hyprL/cache/wallpaper-generated"
waypaperrunning=$HOME/.config/hyprL/cache/waypaper-running
cachefile="$HOME/.config/hyprL/cache/current_wallpaper"
blurredwallpaper="$HOME/.config/hyprL/cache/blurred_wallpaper.png"
squarewallpaper="$HOME/.config/hyprL/cache/square_wallpaper.png"
rasifile="$HOME/.config/hyprL/cache/current_wallpaper.rasi"
blurfile="$HOME/.config/hyprL/settings/blur.sh"
defaultwallpaper="$HOME/wallpaper/default.jpg"
wallpapereffect="$HOME/.config/hyprL/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
