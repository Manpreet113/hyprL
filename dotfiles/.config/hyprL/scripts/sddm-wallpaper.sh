...
sleep 1
clear
cache_file="$HOME/.config/hyprL/cache/current_wallpaper"
...
sddm_theme_tpl="/usr/share/hyprL-hyprland/sddm/theme.conf"
if [ -f $HOME/.config/hyprL/settings/sddm/theme.conf ]; then
    sddm_theme_tpl="$HOME/.config/hyprL/settings/sddm/theme.conf"
...
sudo cp /usr/share/hyprL-hyprland/sddm/sddm.conf /etc/sddm.conf.d/
