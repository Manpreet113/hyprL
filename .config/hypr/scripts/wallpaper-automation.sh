...
sec=$(cat ~/.config/hyprL/settings/wallpaper-automation.sh)
...
if [ ! -f ~/.config/hyprL/cache/wallpaper-automation ]; then
    touch ~/.config/hyprL/cache/wallpaper-automation
    ...
    rm ~/.config/hyprL/cache/wallpaper-automation
