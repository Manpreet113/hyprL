...
# Screenshot Filename
source ~/.config/hyprL/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/hyprL/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/hyprL/settings/screenshot-editor.sh)"
